PImage mainbg, logo, play, levels, gamebg, backhome, lvlbg, lvl1, lvl2, lvl3, avatar, hook, store, pause, pausePanel, resume, restart, storeBg;
PFont gameFont;
